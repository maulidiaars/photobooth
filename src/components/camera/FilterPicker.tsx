  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-center gap-2">
        ...
        {/* Filter list */}
        <div
          className="filter-toolbar-scroll no-scrollbar flex min-w-0 flex-1 gap-1.5 overflow-x-auto overscroll-contain scroll-smooth pb-0.5 select-none sm:gap-2"
          style={{
            scrollbarWidth: "none",
            ...
            return (
              <motion.button
                ...
                onClick={() => {
                  ...
                  /*
                   * IMPORTANT:
                   * Set filter immediately when clicked.
                   *
                   * This updates:
                   * FilterPicker
                   *        ↓
                   * CameraPage photoFilter
                   *        ↓
                   * WebcamView
                   */
                  onChange(filter.id);
